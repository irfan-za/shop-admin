...
export default function ReactTableGroup({products}) {
      ...
      <div className="flex flex-col space-y-8 justify-between">
        {
          ...
          (
            <>
            <ProductsChart currentChart={currentChart} />
